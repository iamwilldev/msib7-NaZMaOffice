                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        @if (Auth::user()->user_type == 'admin')
                            <x-dropdown-link :href="Auth::user()->user_type == 'admin' ? route('admin.dashboard') : route('user.dashboard')" 
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            @auth
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="Auth::user()->user_type == 'admin' ? route('admin.dashboard') : route('user.dashboard')" 
                                    :active="request()->routeIs('admin.dashboard') || request()->routeIs('user.dashboard')">
                        {{ __('Dashboard') }}
                    </x-responsive-nav-link>
            @else
